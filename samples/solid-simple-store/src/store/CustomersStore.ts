...
import { SorterStore } from '../utilities/SorterStore';
...
export class CustomersStore extends ObservableStore<StoreState> {
  sorterService: SorterStore;

  constructor(sorterService: SorterStore) { 
...
export const customersStore = new CustomersStore(new SorterStore());